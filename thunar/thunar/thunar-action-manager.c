...
thunar_action_manager_action_move_to_trash (ThunarActionManager *action_mgr)
{
  ...
  application = thunar_application_get ();
  thunar_application_trash_files (application, action_mgr->widget, action_mgr->files_to_process, THUNAR_OPERATION_LOG_OPERATIONS);
  g_object_unref (G_OBJECT (application));
}
...
thunar_action_manager_action_delete (ThunarActionManager *action_mgr)
{
  ...
  application = thunar_application_get ();
  thunar_application_unlink_files (application, action_mgr->widget, action_mgr->files_to_process, THUNAR_OPERATION_LOG_OPERATIONS);
  g_object_unref (G_OBJECT (application));
...
thunar_action_manager_action_create_folder (ThunarActionManager *action_mgr)
{
  ...
  if (thunar_file_is_trashed (action_mgr->current_directory) || action_mgr->search_mode)
    return TRUE;
