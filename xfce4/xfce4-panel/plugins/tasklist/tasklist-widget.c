                            ...
                            GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_MONITORS_TO_INCLUDE:
      g_value_set_string (value, tasklist->monitors_to_include);
      break;
                            ...
                            GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_MONITORS_TO_INCLUDE:
      xfce_tasklist_set_monitors_to_include (tasklist, g_value_get_string (value));
      break;
                                   ...
                                   XfceTasklistChild *child)
{
  ...
  if (child->tasklist->show_labels)
    ...
    {
      icon_size = MIN (icon_size, child->tasklist->size / child->tasklist->nrows - XFCE_PANEL_PLUGIN_ICON_PADDING);
    }
                                         ...
                                         XfceTasklistChild *child)
{
...
#ifdef ENABLE_X11
  /* show wireframe for the child if enabled */
  ...
  /* connect signal to destroy the window/preview when the user leaves the button */
  if (child->tasklist->show_wireframes || child->tasklist->show_window_previews)
    {
                                         ...
                                         XfceTasklistChild *group_child)
{
  ...
  if (group_child->tasklist->show_labels)
    ...
    {
      icon_size = MIN (icon_size, group_child->tasklist->size / group_child->tasklist->nrows - XFCE_PANEL_PLUGIN_ICON_PADDING);
    }
                                    ...
                                    XfceTasklist *tasklist)
{
  ...
  gtk_list_store_insert_with_values (GTK_LIST_STORE (store), &iter, n++,
                                     OUTPUT_NAME, MONITORS_TO_INCLUDE_ALL,
  ...
  gtk_list_store_insert_with_values (GTK_LIST_STORE (store), &iter, n++,
                                     OUTPUT_NAME, MONITORS_TO_INCLUDE_PANEL,
